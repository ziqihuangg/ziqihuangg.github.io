...
Her research interests broadly lie in computer vision and deep learning, with a focus on generative models (image/video generation and editing), visual reasoning (physical reasoning, world models, embodied intelligence), and evaluation (benchmarks and evaluation paradigms). 

- **Evaluation**: [VBench](https://vchitect.github.io/VBench-project/), [VBench++](https://vchitect.github.io/VBench-project/), [VBench-2.0](https://vchitect.github.io/VBench-2.0-project/), [Evaluation Agent](https://vchitect.github.io/Evaluation-Agent-project/), [Uni-MMMU](https://vchitect.github.io/Uni-MMMU-Project/).
- **Generation**: [Collaborative Diffusion](https://ziqihuangg.github.io/projects/collaborative-diffusion.html), [ReVersion](https://ziqihuangg.github.io/projects/reversion.html), [Talk-to-Edit](https://www.mmlab-ntu.com/project/talkedit/index.html), [FreeU](https://chenyangsi.top/FreeU/), [LaVie](https://vchitect.github.io/LaVie-project/), [Vchitect-2.0](https://vchitect.intern-ai.org.cn/), [MAViS](https://www.arxiv.org/abs/2508.08487), [RealDPO](https://vchitect.github.io/RealDPO-Project/).
- **Reasoning**: [VChain](https://eyeline-labs.github.io/VChain/), [Roadmap: Simulating the Visual World](https://world-model-roadmap.github.io), [Chain-of-Steps](https://www.wruisi.com/demystifying_video_reasoning/), [BabyVision](https://arxiv.org/abs/2601.06521), [Apple-π](https://21yrm.github.io/Apple-PI-homepage/), [UniT](https://arxiv.org/abs/2602.12279).
...
European Chapter of the Association for Computational Linguistics (<strong>EACL</strong>), 2026 (Main Conference) 
...
<strong>SIGGRAPH Asia</strong> (Conference Track), 2025 <br />
